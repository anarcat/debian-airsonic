...
RUN curl -SL -o /usr/local/tomcat/webapps/airsonic.war https://github.com/airsonic/airsonic/releases/download/v10.5.0/airsonic.war &&\
  curl -SL -o /usr/local/tomcat/webapps/artifacts-checksums.sha.asc https://github.com/airsonic/airsonic/releases/download/v10.5.0/artifacts-checksums.sha.asc && \
